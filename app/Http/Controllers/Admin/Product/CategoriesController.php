...
use App\DataTables\Product\ProductCategoriesDataTable;
...
class CategoriesController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        notyf('Product Category Created!', 'success');
    ...
    public function update(Request $request, $id) {
        ...
        notyf('Product Category Updated!', 'info');
    ...
    public function destroy($id) {
        ...
        notyf('Product Category Deleted!', 'warning');

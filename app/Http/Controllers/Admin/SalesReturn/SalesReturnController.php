...
use App\DataTables\SalesReturn\SaleReturnsDataTable;
use App\Http\Requests\Admin\SalesReturn\StoreSaleReturnRequest;
use App\Http\Requests\Admin\SalesReturn\UpdateSaleReturnRequest;
...
class SalesReturnController extends Controller
{
    ...
    public function index(SaleReturnsDataTable $dataTable) {
        ...
        return $dataTable->render('Admin.salesreturn.index');
    }
    ...
    public function store(StoreSaleReturnRequest $request) {
        ...
        notyf('Sale Return Created!', 'success');
    ...
    public function update(UpdateSaleReturnRequest $request, SaleReturn $sale_return) {
        ...
        notyf('Sale Return Updated!', 'info');
    ...
    public function destroy(SaleReturn $sale_return) {
        ...
        notyf('Sale Return Deleted!', 'warning');

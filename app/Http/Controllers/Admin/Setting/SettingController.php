...
use App\Http\Requests\Admin\Setting\StoreSettingsRequest;
use App\Http\Requests\Admin\Setting\StoreSmtpSettingsRequest;
...
class SettingController extends Controller
{
    ...
    public function updateSmtp(StoreSmtpSettingsRequest $request) {
        ...
        try {
            ...
            notyf('Mail Settings Updated!', 'info');

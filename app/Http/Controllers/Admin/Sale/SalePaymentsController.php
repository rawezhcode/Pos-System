...
use App\DataTables\Sale\SalePaymentsDataTable;
use App\Models\Sale;
...
class SalePaymentsController extends Controller
{
    ...
    public function index($sale_id, SalePaymentsDataTable $dataTable) {
        ...
        return $dataTable->render('Admin.sale.payments.index', compact('sale'));
    }
    ...
    public function create($sale_id) {
        ...
        return view('Admin.sale.payments.create', compact('sale'));
    }
    ...
    public function store(Request $request) {
        ...
        notyf('Sale Payment Created!', 'success');
    ...
    public function edit($sale_id, SalePayment $salePayment) {
        ...
        return view('Admin.sale.payments.edit', compact('salePayment', 'sale'));
    }
    ...
    public function update(Request $request, SalePayment $salePayment) {
        ...
        notyf('Sale Payment Updated!', 'info');
    ...
    public function destroy(SalePayment $salePayment) {
        ...
        notyf('Sale Payment Deleted!', 'warning');

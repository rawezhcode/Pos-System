...
use App\DataTables\PurchasesReturn\PurchaseReturnPaymentsDataTable;
...
class PurchaseReturnPaymentsController extends Controller
{
    ...
    public function index($purchase_return_id, PurchaseReturnPaymentsDataTable $dataTable) {
        ...
        return $dataTable->render('Admin.purchasesreturn.payments.index', compact('purchase_return'));
    }
    ...
    public function create($purchase_return_id) {
        ...
        return view('Admin.PurchasesReturn.payments.create', compact('purchase_return'));
    }
    ...
    public function store(Request $request) {
        ...
        notyf('Purchase Return Payment Created!', 'success');
    ...
    public function edit($purchase_return_id, PurchaseReturnPayment $purchaseReturnPayment) {
        ...
        return view('Admin.purchasesreturn.payments.edit', compact('purchaseReturnPayment', 'purchase_return'));
    }
    ...
    public function update(Request $request, PurchaseReturnPayment $purchaseReturnPayment) {
        ...
        notyf('Purchase Return Payment Updated!', 'info');
    ...
    public function destroy(PurchaseReturnPayment $purchaseReturnPayment) {
        ...
        notyf('Purchase Return Payment Deleted!', 'warning');

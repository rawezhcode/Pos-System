...
use App\DataTables\Quotation\QuotationsDataTable;
...
class QuotationController extends Controller
{
    ...
    public function index(QuotationsDataTable $dataTable) {
        ...
        return $dataTable->render('Admin.quotation.index');
    }
    ...
    public function store(StoreQuotationRequest $request) {
        ...
        notyf('Quotation Created!', 'success');
    ...
    public function destroy(Quotation $quotation) {
        ...
        notyf('Quotation Deleted!', 'warning');
